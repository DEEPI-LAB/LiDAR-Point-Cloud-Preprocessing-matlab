...
for i=1:length(gu),
    ...
    if ~iscellstr(clr)&&~ischar(clr),
        set(h(1,i),'LineStyle','none','Color',clr(i,:),'Marker','o','MarkerSize',2.5,'MarkerFaceColor',mrkfclr(i,:));
    else
        set(h(1,i),'LineStyle','none','Color',clr{1,i},'Marker','o','MarkerSize',2.5,'MarkerFaceColor',mrkfclr{1,i});
    end;
end;
